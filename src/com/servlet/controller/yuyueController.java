...
@WebServlet(value = "/yuyueController")
//预约按钮
public class yuyueController extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String sql ="INSERT INTO examine(articles,number,types,time,pass,name )"+
                    "VALUE (?,?,?,current_date ,?,?)";
            statement = connection.prepareStatement(sql);
            statement.setString(1,name);
            statement.setInt(2,str1);
            statement.setString(3,"预约");
